...
// Before you insert you need to build 1 api  call and get all these fields as input, Need to build schema first  and then once you got
//  these as input then you have to submit the document 
